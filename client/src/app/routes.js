...
const JwtUserLogin = Loadable(lazy(() => import("app/views/sessions/JwtUserLogin")));
const JwtUserRegister = Loadable(lazy(() => import("app/views/sessions/JwtUserRegister")));
const UserForgotPassword = Loadable(lazy(() => import("app/views/sessions/UserForgotPassword")));
const JwtVendorLogin = Loadable(lazy(() => import("app/views/sessions/JwtVendorLogin")));
const JwtVendorRegister = Loadable(lazy(() => import("app/views/sessions/JwtVendorRegister")));
const VendorForgotPassword = Loadable(lazy(() => import("app/views/sessions/VendorForgotPassword")));
